...
goog.require('clojure.string');
logging_dashboard.main.packer = new cljs.core.Keyword(null,"edn","edn",1317840885);
...
logging_dashboard.main.chsk = chsk_17311;

logging_dashboard.main.ch_chsk = ch_recv_17310;

logging_dashboard.main.chsk_send_BANG_ = send_fn_17309;

logging_dashboard.main.chsk_state = state_17308;
logging_dashboard.main.event_msg_handler = (function (){var method_table__4653__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"logging-dashboard.main","event-msg-handler"),new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__4657__auto__,method_table__4653__auto__,prefer_table__4654__auto__,method_cache__4655__auto__,cached_hierarchy__4656__auto__));
})();
logging_dashboard.main.event_msg_handler_STAR_ = (function event_msg_handler_STAR_(p__17312){
...
return logging_dashboard.main.event_msg_handler.call(null,ev_msg);
});
cljs.core._add_method.call(null,logging_dashboard.main.event_msg_handler,new cljs.core.Keyword(null,"default","default",-1987822328),(function (p__17315){
...
cljs.core._add_method.call(null,logging_dashboard.main.event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__17317){
...
cljs.core._add_method.call(null,logging_dashboard.main.event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__17319){
...
cljs.core._add_method.call(null,logging_dashboard.main.event_msg_handler,new cljs.core.Keyword("chsk","handshake","chsk/handshake",64910686),(function (p__17321){
...
return logging_dashboard.main.chsk_send_BANG_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("example","button1","example/button1",-349884645),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"had-a-callback?","had-a-callback?",-512946762),"nope"], null)], null));
...
return logging_dashboard.main.chsk_send_BANG_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("example","button2","example/button2",-675598425),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"had-a-callback?","had-a-callback?",-512946762),"indeed"], null)], null),(5000),((function (target_el_17327,temp__4126__auto___17326){
...
logging_dashboard.main.router_ = cljs.core.atom.call(null,null);
logging_dashboard.main.stop_router_BANG_ = (function stop_router_BANG_(){
var temp__4126__auto__ = cljs.core.deref.call(null,logging_dashboard.main.router_);
...
logging_dashboard.main.start_router_BANG_ = (function start_router_BANG_(){
logging_dashboard.main.stop_router_BANG_.call(null);

return cljs.core.reset_BANG_.call(null,logging_dashboard.main.router_,taoensso.sente.start_chsk_router_BANG_.call(null,logging_dashboard.main.ch_chsk,logging_dashboard.main.event_msg_handler_STAR_));
});
logging_dashboard.main.start_BANG_ = (function start_BANG_(){
return logging_dashboard.main.start_router_BANG_.call(null);
});
