...
taoensso.sente.interfaces.IPacker = (function (){var obj24897 = {};
return obj24897;
})();
...
return (function (){var or__3761__auto__ = (taoensso.sente.interfaces.pack[goog.typeOf(x__4400__auto__)]);
if(or__3761__auto__){
...
var x__4400__auto__ = (((_ == null))?null:_);
return (function (){var or__3761__auto__ = (taoensso.sente.interfaces.unpack[goog.typeOf(x__4400__auto__)]);
if(or__3761__auto__){
return or__3761__auto__;
} else {
...
return G__24899.taoensso$sente$interfaces$IPacker$;
}
})())){
return true;
} else {
if((!G__24899.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,taoensso.sente.interfaces.IPacker,G__24899);
} else {
return false;
}
}
